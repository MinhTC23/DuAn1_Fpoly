...
//        ps.setString(13, maHd);
 ...
 //1512
    ...
    public ArrayList<HoaDon> getHoaDonSDT(String sdt) throws SQLException {
        ArrayList<HoaDon> list = new ArrayList<>();

        String sql = "SELECT HoaDon.MaHD, MaNV, HoaDon.NgayTao, SoLuong,NgayThanhToan, HTTT.TenHT, TenKH, HoaDon.TongTien, HoaDon.TrangThai FROM HoaDon left join HTTT on HoaDon.Id=HTTT.Id_HoaDon join KhachHang on HoaDon.Id_KhachHang = KhachHang.Id where SDT = ?";
