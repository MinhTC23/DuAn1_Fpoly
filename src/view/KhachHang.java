...
public class KhachHang extends javax.swing.JPanel implements Runnable, ThreadFactory {
    ...
    private void loadThongTin() {
        try {
            ...
            txtNgaySinh.setDate(LocalDate.parse(QuetMaKhachHang.ngaySinh));
...
//        }
    ...
    private void initComponents() {
        ...
        btnQuet.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/qrcode_scan_icon_136286.png"))); // NOI18N
