...
//        }
    ...
    private void initComponents() {
        ...
        tbnQr.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/MaVach.png"))); // NOI18N
...
//                            doc.add(paragraph6);
                        ...
                        Paragraph paragraph7 = new Paragraph("Cam on quy khach da den cua hang dien thoai Nga Ngo");
...
//                            doc.add(paragraph6);
                        ...
                        tbl.addCell("Mã Sản Phẩm ");
                        tbl.addCell("Tên Sản Phẩm");
                        tbl.addCell("Số Lượng");
                        tbl.addCell("Giá Bán");
                        tbl.addCell("Mức Giảm Giá");
                        ...
                        Paragraph paragraph6 = new Paragraph("Tổng Tiền: " + tongTien + ".000" + "VND");
                        paragraph6.setIndentationLeft(50);

                        Paragraph paragraph7 = new Paragraph("Cảm ơn quý khách đã đến Cửa Hàng điện thoại nga ngố!");
                        paragraph7.setIndentationLeft(120);
                        paragraph7.setIndentationRight(80);
                        doc.add(paragraph6);
                        doc.add(paragraph7);
